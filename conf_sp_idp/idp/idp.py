...
"""
    Identity Provider (IdP) app responsible for handling user authentication and authorization.
    since imported file from https://github.com/IdentityPython/pysaml2/blob/master/example/idp2/idp.py
    pylint was disabled for entire file
"""
