# -*- coding: utf-8 -*-
"""
This module contains configuration settings for the IDP.

imported from https://github.com/IdentityPython/pysaml2/blob/master/example/idp2/idp_conf.py.example
"""
