...
"""
    File to generate metadata for the identity provider.
    imported file from https://github.com/IdentityPython/pysaml2/blob/master/src/saml2/tools/make_metadata.py
"""
