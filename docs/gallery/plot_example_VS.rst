...
.. literalinclude:: ../samples/config/wms/VS_template.py

It produces the following plot, filled with a temperature colourmap and contour lines

.. image:: ../samples/config/wms/VS_template.png
...
In this case, temperature is both the map filler and the contour.
...
That's about it. Feel free to :download:`download this template <../samples/config/wms/VS_template.py>`
