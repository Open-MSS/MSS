...
leave out the 'source' here and below). ::
    ...
    (mssenv) $ mamba install mss=4.0.3 python
...
search for MSS what you can get ::
   ...
   ...
   mss                            4.0.3  py38....._0  conda-forge
   mss                            4.0.3  py39....._0  conda-forge
...
in this example 4.0.3 and python as second option ::
...
* conda create -n mssenv mamba
* conda activate mssenv
* mamba install mss=4.0.3 python
