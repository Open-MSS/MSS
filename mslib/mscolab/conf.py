...
# for postgres
# TEST_SQLALCHEMY_DB_URI = 'postgresql://{}:{}@{}/{}'.format(TEST_DB_USER, TEST_DB_PASSWORD, TEST_DB_HOST, TEST_DB_NAME)
...
try:
    """
    if mscolab_settings is defined somewhere, all the variables from there replace above variables.
    """
    from mscolab_settings import *
