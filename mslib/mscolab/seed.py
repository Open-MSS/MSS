...
from mslib.mscolab.server import get_default_content
        ...
        if not operation_available:
            ...
            with fs.open_fs(mscolab_settings.OPERATIONS_DATA) as file_dir:
                if not file_dir.exists(path):
                    ...
                    file_dir.writetext(f'{path}/main.ftml', get_default_content)
                    # initiate git
        ...
        if not operation_available:
            ...
            with fs.open_fs(mscolab_settings.OPERATIONS_DATA) as file_dir:
                if not file_dir.exists(operation_name):
                    ...
                    file_dir.writetext(f'{operation_name}/main.ftml', get_default_content)
                    # initiate git
...
def seed_data():
    ...
    with fs.open_fs(mscolab_settings.OPERATIONS_DATA) as file_dir:
        ...
        for file_path in file_paths:
            ...
            file_dir.writetext(f'{file_path}/main.ftml', get_default_content)
            # initiate git
