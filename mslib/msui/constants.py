...
MSS_CONFIG_PATH = os.path.join(QStandardPaths.writableLocation(
    QStandardPaths.ConfigLocation), "mss")
...
if os.path.exists(MSS_SETTINGS):
    ...
    mscolab_data_dir = os.path.join(QStandardPaths.writableLocation(
        QStandardPaths.DataLocation), "mss")
POSIX = {
    "application_destination": os.path.join(
        QStandardPaths.writableLocation(QStandardPaths.DataLocation),
        "applications", "mss{}.desktop"),
    "icon_destination": os.path.join(
        QStandardPaths.writableLocation(QStandardPaths.DataLocation),
        "icons", "hicolor", "{}", "apps", "mss-logo{}.png"),
...
class MissionSupportSystemDefaultConfig(object):
    ...
    data_dir = os.path.join(QStandardPaths.writableLocation(
        QStandardPaths.DocumentsLocation), "mss")
