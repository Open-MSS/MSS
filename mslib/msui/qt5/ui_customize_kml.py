...
class Ui_CustomizeKMLDialog(object):
    def setupUi(self, CustomizeKMLDialog):
        ...
        self.pushButton = QtWidgets.QPushButton(CustomizeKMLDialog)
        ...
        self.pushButton_2 = QtWidgets.QPushButton(CustomizeKMLDialog)
    ...
    def retranslateUi(self, CustomizeKMLDialog):
        ...
        self.pushButton.setText(_translate("CustomizeKMLDialog", "Change Colour"))
        self.label_2.setText(_translate("CustomizeKMLDialog", "LineWidth "))
        self.pushButton_2.setText(_translate("CustomizeKMLDialog", "Change LineWidth"))
