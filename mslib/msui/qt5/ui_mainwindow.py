...
class Ui_MSSMainWindow(object):
    def setupUi(self, MSSMainWindow):
        MSSMainWindow.setObjectName("MSUIMainWindow")
        ...
        self.actionLeaveOperation = QtWidgets.QAction(MSSMainWindow)
    ...
    def retranslateUi(self, MSSMainWindow):
        ...
        MSSMainWindow.setWindowTitle(_translate("MSUIMainWindow", "Mission Support System"))
...
"Double click a operation to activate and view its description."))
        ...
        self.openOperationsMSCLabel.setText(_translate("MSUIMainWindow", "Operations:"))
