...
"Save a flight track to name it."))
        ...
        self.actionSaveActiveFlightTrack.setShortcut(_translate("MSSMainWindow", "Ctrl+Alt+S"))
        ...
        self.actionQuit.setShortcut(_translate("MSSMainWindow", "Ctrl+Shift+Q"))
        ...
        self.actionBringMainWindowToFront.setShortcut(_translate("MSSMainWindow", "Ctrl+Shift+Up"))
