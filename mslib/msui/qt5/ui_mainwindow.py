...
class Ui_MSUIMainWindow(object):
    def setupUi(self, MSUIMainWindow):
        ...
        self.MSColabConnectGb.setMaximumSize(QtCore.QSize(16777215, 100))
        ...
        self.openFlightTracksGb.setMaximumSize(QtCore.QSize(16777215, 300))
        ...
        self.openViewsGb.setMaximumSize(QtCore.QSize(16777215, 210))
        ...
        self.shareViewGroupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.shareViewGroupBox.setMaximumSize(QtCore.QSize(16777215, 150))
        self.shareViewGroupBox.setTitle("")
        self.shareViewGroupBox.setObjectName("shareViewGroupBox")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.shareViewGroupBox)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.label_2 = QtWidgets.QLabel(self.shareViewGroupBox)
        self.label_2.setMaximumSize(QtCore.QSize(16777215, 18))
        self.label_2.setObjectName("label_2")
        self.verticalLayout_4.addWidget(self.label_2)
        self.listView = QtWidgets.QListView(self.shareViewGroupBox)
        ...
        self.menuCopyIntoNew = QtWidgets.QMenu(self.menuFile)
        self.menuCopyIntoNew.setObjectName("menuCopyIntoNew")
        ...
        self.actionImportFromSelected = QtWidgets.QAction(MSUIMainWindow)
        self.actionImportFromSelected.setObjectName("actionImportFromSelected")
        self.actionCopyIntoLocalFlightTrack = QtWidgets.QAction(MSUIMainWindow)
        self.actionCopyIntoLocalFlightTrack.setObjectName("actionCopyIntoLocalFlightTrack")
        self.actionCopyIntoMSColabOperation = QtWidgets.QAction(MSUIMainWindow)
        self.actionCopyIntoMSColabOperation.setObjectName("actionCopyIntoMSColabOperation")
        self.actionCopyIntoNewLocalFlightTrack = QtWidgets.QAction(MSUIMainWindow)
        self.actionCopyIntoNewLocalFlightTrack.setObjectName("actionCopyIntoNewLocalFlightTrack")
        self.actionCopyIntoNewMSColabOperation = QtWidgets.QAction(MSUIMainWindow)
        self.actionCopyIntoNewMSColabOperation.setObjectName("actionCopyIntoNewMSColabOperation")
        self.actionOpenManageView = QtWidgets.QAction(MSUIMainWindow)
        self.actionOpenManageView.setObjectName("actionOpenManageView")
        self.menuImportFlightTrack.addAction(self.actionImportFromSelected)
        self.menuNew.addAction(self.actionNewFlightTrack)
        self.menuNew.addAction(self.actionAddOperation)
        self.menuCopyIntoNew.addAction(self.actionCopyIntoNewLocalFlightTrack)
        self.menuCopyIntoNew.addAction(self.actionCopyIntoNewMSColabOperation)
        self.menuFile.addAction(self.menuNew.menuAction())
        self.menuFile.addAction(self.menuImportFlightTrack.menuAction())
        self.menuFile.addAction(self.menuCopyIntoNew.menuAction())
        ...
        self.menuOperation.addSeparator()
        self.menuOperation.addSeparator()
        self.menuOperation.addAction(self.actionOpenManageView)
...
"Double click a operation to activate and view its description."))
        ...
        self.menuCopyIntoNew.setTitle(_translate("MSUIMainWindow", "Copy Into New"))
        ...
        self.actionImportFromSelected.setText(_translate("MSUIMainWindow", "From Selected"))
        self.actionCopyIntoLocalFlightTrack.setText(_translate("MSUIMainWindow", "Local Flight Track"))
