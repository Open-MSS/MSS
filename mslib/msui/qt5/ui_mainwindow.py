...
class Ui_MSSMainWindow(object):
    def setupUi(self, MSSMainWindow):
        ...
        self.action1DView = QtWidgets.QAction(MSSMainWindow)
        self.action1DView.setObjectName("action1DView")
        ...
        self.menu_View.addAction(self.action1DView)
...
"Save a flight track to name it."))
        ...
        self.action1DView.setText(_translate("MSSMainWindow", "&1D View"))
        self.action1DView.setToolTip(_translate("MSSMainWindow", "1D View"))
        self.action1DView.setShortcut(_translate("MSSMainWindow", "Ctrl+1"))
