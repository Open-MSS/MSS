...
"Save a flight track to name it."))
        ...
        self.inactiveOperationsLabel.setText(_translate("MSUIMainWindow", "Inactive Operations"))
...
"Double click a operation to activate and view its description."))
        ...
        self.activeOperationsLabel.setText(_translate("MSUIMainWindow", "Active Operations"))
