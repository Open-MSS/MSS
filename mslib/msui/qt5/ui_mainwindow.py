...
class Ui_MSUIMainWindow(object):
    def setupUi(self, MSUIMainWindow):
        ...
        self.serverOptionsCb.addItem("")
        self.serverOptionsCb.addItem("")
        self.gridLayout_3.addWidget(self.serverOptionsCb, 8, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.filterCategoryCb, 7, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.workLocallyCheckbox, 8, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.listInactiveOperationsMSC, 3, 0, 1, 2)
        self.categoryLabel = QtWidgets.QLabel(self.openOperationsGb)
        self.categoryLabel.setObjectName("categoryLabel")
        self.gridLayout_3.addWidget(self.categoryLabel, 7, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.workingStatusLabel, 4, 0, 1, 2)
        ...
        self.label = QtWidgets.QLabel(self.openOperationsGb)
        ...
        self.actionRenameActiveFlightTrack = QtWidgets.QAction(MSUIMainWindow)
        self.actionRenameActiveFlightTrack.setObjectName("actionRenameActiveFlightTrack")
        ...
        self.actionActivateOperation = QtWidgets.QAction(MSUIMainWindow)
        self.actionActivateOperation.setObjectName("actionActivateOperation")
        ...
        self.menuFile.addAction(self.actionRenameActiveFlightTrack)
        ...
        self.menuOperation.addAction(self.actionActivateOperation)
...
"Save a flight track to name it."))
        ...
        self.connectBtn.setText(_translate("MSUIMainWindow", "Connect to MSColab"))
        ...
        self.openOperationsMSCLabel.setText(_translate("MSUIMainWindow", "Active Operations:"))
...
"Double click a operation to activate and view its description."))
        self.label.setText(_translate("MSUIMainWindow", "Inactive Operations:"))
        ...
        self.actionRenameActiveFlightTrack.setText(_translate("MSUIMainWindow", "Rename Active Flight Track"))
        self.actionRenameActiveFlightTrack.setShortcut(_translate("MSUIMainWindow", "Ctrl+Shift+S"))
        ...
        self.actionActivateOperation.setText(_translate("MSUIMainWindow", "Activate Operation"))
