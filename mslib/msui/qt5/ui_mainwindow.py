...
class Ui_MSUIMainWindow(object):
    def setupUi(self, MSUIMainWindow):
        ...
        self.actionCopyFromSelected = QtWidgets.QAction(MSUIMainWindow)
        self.actionCopyFromSelected.setObjectName("actionCopyFromSelected")
        ...
        self.menuFile.addAction(self.actionCopyFromSelected)
        self.menuFile.addSeparator()
...
"Double click a operation to activate and view its description."))
        ...
        self.actionCopyFromSelected.setText(_translate("MSUIMainWindow", "Copy From Selected"))
