...
class Ui_MSUIMainWindow(object):
    def setupUi(self, MSUIMainWindow):
        ...
        self.gridLayout_3.addWidget(self.workLocallyCheckbox, 12, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.pbOpenOperationArchive, 13, 0, 1, 2)
        ...
        self.StoreLayout = QtWidgets.QPushButton(self.openOperationsGb)
        self.StoreLayout.setObjectName("StoreLayout")
        self.gridLayout_3.addWidget(self.StoreLayout, 10, 1, 1, 1)
        ...
        self.serverOptionsCb.addItem("")
        self.serverOptionsCb.addItem("")
        self.gridLayout_3.addWidget(self.serverOptionsCb, 12, 1, 1, 1)
        ...
        self.RestoreLayout = QtWidgets.QPushButton(self.openOperationsGb)
        self.RestoreLayout.setObjectName("RestoreLayout")
        self.gridLayout_3.addWidget(self.RestoreLayout, 11, 1, 1, 1)
...
"Save a flight track to name it."))
        ...
        self.StoreLayout.setText(_translate("MSUIMainWindow", "Store Layout"))
...
"Double click a operation to activate and view its description."))
        self.RestoreLayout.setText(_translate("MSUIMainWindow", "Restore Layout"))
