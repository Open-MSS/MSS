...
class Ui_MSUIMainWindow(object):
    def setupUi(self, MSUIMainWindow):
        ...
        self.fullnameLabel = QtWidgets.QLabel(self.MSColabConnectGb)
        self.fullnameLabel.setObjectName("fullnameLabel")
        self.userOptionsHL.addWidget(self.fullnameLabel, 0, QtCore.Qt.AlignRight)
        ...
        self.openFlightTracksGb.setMaximumSize(QtCore.QSize(16777215, 250))
        ...
        self.openViewsGb.setMaximumSize(QtCore.QSize(16777215, 200))
        ...
        self.listWidget.setGeometry(QtCore.QRect(10, 40, 256, 61))
        self.listWidget.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.listWidget.setObjectName("listWidget")
        self.label = QtWidgets.QLabel(self.groupBox)
        self.label.setGeometry(QtCore.QRect(10, 10, 256, 18))
        self.label.setObjectName("label")
        self.lineEdit = QtWidgets.QLineEdit(self.groupBox)
        self.lineEdit.setGeometry(QtCore.QRect(10, 60, 181, 26))
        self.lineEdit.setObjectName("lineEdit")
        self.pushButton = QtWidgets.QPushButton(self.groupBox)
        self.pushButton.setGeometry(QtCore.QRect(200, 60, 0, 0))
        self.pushButton.setMaximumSize(QtCore.QSize(1000, 1000))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_2.setGeometry(QtCore.QRect(190, 60, 75, 26))
        self.pushButton_2.setMaximumSize(QtCore.QSize(1670000, 16777215))
...
"Save a flight track to name it."))
        ...
        self.label.setText(_translate("MSUIMainWindow", "Save View:"))
        self.pushButton.setText(_translate("MSUIMainWindow", "Save"))
        self.pushButton_2.setText(_translate("MSUIMainWindow", "Save"))
