...
class Ui_MSSMainWindow(object):
    def setupUi(self, MSSMainWindow):
        ...
        self.actionConfigurationEditor = QtWidgets.QAction(MSSMainWindow)
        self.actionConfigurationEditor.setObjectName("actionConfigurationEditor")
        ...
        self.menu_File.addSeparator()
        self.menu_File.addAction(self.actionLoadConfigurationFile)
        self.menu_File.addAction(self.actionConfigurationEditor)
        self.menu_File.addSeparator()
        ...
        self.menu_View.addAction(self.actionLinearView)
...
"Save a flight track to name it."))
        ...
        self.action_Quit.setShortcut(_translate("MSSMainWindow", "Ctrl+Shift+Q"))
        self.actionNewFlightTrack.setText(_translate("MSSMainWindow", "&New Flight Track"))
        self.actionNewFlightTrack.setShortcut(_translate("MSSMainWindow", "Ctrl+Shift+N"))
        self.actionOpenFlightTrack.setText(_translate("MSSMainWindow", "&Open Flight Track..."))
        self.actionOpenFlightTrack.setShortcut(_translate("MSSMainWindow", "Ctrl+Shift+O"))
        self.actionSaveActiveFlightTrack.setText(_translate("MSSMainWindow", "&Save Active Flight Track"))
        self.actionSaveActiveFlightTrack.setShortcut(_translate("MSSMainWindow", "Ctrl+Shift+S"))
        ...
        self.actionTopView.setShortcut(_translate("MSSMainWindow", "Ctrl+Shift+H"))
        self.actionSideView.setText(_translate("MSSMainWindow", "&Side View (Vertical Section)"))
        self.actionSideView.setShortcut(_translate("MSSMainWindow", "Ctrl+Shift+V"))
        self.actionTableView.setText(_translate("MSSMainWindow", "T&able View"))
        self.actionTableView.setShortcut(_translate("MSSMainWindow", "Ctrl+Shift+T"))
        self.actionAboutMSUI.setText(_translate("MSSMainWindow", "&About MSS"))
        self.actionConfigurationEditor.setText(_translate("MSSMainWindow", "Configuration Editor"))
        self.actionConfigurationEditor.setToolTip(_translate("MSSMainWindow", "Start the configuration editor."))
        ...
        self.actionLoadConfigurationFile.setText(_translate("MSSMainWindow", "Load Configuration File"))
        self.actionLoadConfigurationFile.setToolTip(_translate("MSSMainWindow", "Load a JSON configuration file"))
        self.actionLinearView.setText(_translate("MSSMainWindow", "&Linear View"))
        self.actionLinearView.setToolTip(_translate("MSSMainWindow", "Linear View"))
        self.actionLinearView.setShortcut(_translate("MSSMainWindow", "Ctrl+Shift+L"))
