...
class Ui_MSSMainWindow_new(object):
    def setupUi(self, MSSMainWindow_new):
        ...
        self.projectOptionsCb.addItem("")
        self.projectOptionsCb.addItem("")
        self.projectOptionsCb.addItem("")
        self.projectOptionsCb.addItem("")
        self.projectOptionsCb.addItem("")
        self.projectOptionsCb.addItem("")
        self.gridLayout_2.addWidget(self.projectOptionsCb, 2, 2, 1, 1)
        self.checkBox = QtWidgets.QCheckBox(self.shareTab)
        self.checkBox.setObjectName("checkBox")
        self.gridLayout_2.addWidget(self.checkBox, 2, 0, 1, 1)
        self.comboBox = QtWidgets.QComboBox(self.shareTab)
    ...
    def retranslateUi(self, MSSMainWindow_new):
        ...
        self.projectOptionsCb.setItemText(0, _translate("MSSMainWindow_new", "Project options"))
        self.projectOptionsCb.setItemText(1, _translate("MSSMainWindow_new", "Chat"))
        self.projectOptionsCb.setItemText(2, _translate("MSSMainWindow_new", "Version History"))
        self.projectOptionsCb.setItemText(3, _translate("MSSMainWindow_new", "Manage Users"))
        self.projectOptionsCb.setItemText(4, _translate("MSSMainWindow_new", "Share Project"))
        self.projectOptionsCb.setItemText(5, _translate("MSSMainWindow_new", "Delete Project"))
        self.checkBox.setText(_translate("MSSMainWindow_new", "Work Locally"))
        self.comboBox.setItemText(0, _translate("MSSMainWindow_new", "Sandbox Options"))
        self.comboBox.setItemText(1, _translate("MSSMainWindow_new", "Fetch From Server"))
        self.comboBox.setItemText(2, _translate("MSSMainWindow_new", "Save To Server"))
