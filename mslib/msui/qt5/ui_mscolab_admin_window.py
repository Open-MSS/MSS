...
class Ui_MscolabAdminWindow(object):
    def setupUi(self, MscolabAdminWindow):
        ...
        self.widget.setGeometry(QtCore.QRect(0, 10, 961, 621))
        ...
        self.addUsersPermission = QtWidgets.QComboBox(self.widget)
        ...
        self.addUsersBtn = QtWidgets.QPushButton(self.widget)
        ...
        self.modifyUsersSearch = QtWidgets.QLineEdit(self.widget)
        ...
        self.modifyUsersPermissionFilter = QtWidgets.QComboBox(self.widget)
        ...
        self.selectAllModifyBtn = QtWidgets.QPushButton(self.widget)
        self.selectAllModifyBtn.setObjectName("selectAllModifyBtn")
        self.horizontalLayout_4.addWidget(self.selectAllModifyBtn)
        self.deselectAllModifyBtn = QtWidgets.QPushButton(self.widget)
        ...
        self.modifyUsersTable = QtWidgets.QTableWidget(self.widget)
        ...
        self.modifyUsersPermission = QtWidgets.QComboBox(self.widget)
        ...
        self.modifyUsersBtn = QtWidgets.QPushButton(self.widget)
        self.modifyUsersBtn.setObjectName("modifyUsersBtn")
        self.horizontalLayout_5.addWidget(self.modifyUsersBtn)
        self.deleteUsersBtn = QtWidgets.QPushButton(self.widget)
    ...
    def retranslateUi(self, MscolabAdminWindow):
        ...
        self.modifyUsersPermissionFilter.setItemText(0, _translate("MscolabAdminWindow", "(Filter By Permission)"))
