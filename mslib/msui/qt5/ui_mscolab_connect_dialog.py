...
class Ui_MSColabConnectDialog(object):
    def setupUi(self, MSColabConnectDialog):
        ...
        MSColabConnectDialog.resize(478, 300)
        ...
        self.gridLayout_2.addWidget(self.newEmailLabel, 3, 0, 1, 1, QtCore.Qt.AlignRight)
        ...
        self.gridLayout_2.addWidget(self.newConfirmPasswordLabel, 5, 0, 1, 1, QtCore.Qt.AlignRight)
        self.newPasswordLabel = QtWidgets.QLabel(self.newuserPage)
        self.newPasswordLabel.setObjectName("newPasswordLabel")
        self.gridLayout_2.addWidget(self.newPasswordLabel, 4, 0, 1, 1, QtCore.Qt.AlignRight)
        self.newEmailLe = QtWidgets.QLineEdit(self.newuserPage)
        self.newEmailLe.setObjectName("newEmailLe")
        self.gridLayout_2.addWidget(self.newEmailLe, 3, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.newConfirmPasswordLe, 5, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.newPasswordLe, 4, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.newUserBb, 6, 1, 1, 1, QtCore.Qt.AlignLeft)
        self.fullNameLabel = QtWidgets.QLineEdit(self.newuserPage)
        self.fullNameLabel.setObjectName("fullNameLabel")
        self.gridLayout_2.addWidget(self.fullNameLabel, 2, 1, 1, 1)
        self.label = QtWidgets.QLabel(self.newuserPage)
    ...
    def retranslateUi(self, MSColabConnectDialog):
        ...
        self.fullNameLabel.setPlaceholderText(_translate("MSColabConnectDialog", "John David Doe"))
        self.label.setText(_translate("MSColabConnectDialog", "            Fullname:"))
