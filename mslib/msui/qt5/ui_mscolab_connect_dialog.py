...
class Ui_MSColabConnectDialog(object):
    def setupUi(self, MSColabConnectDialog):
        ...
        self.newFullnameLe = QtWidgets.QLineEdit(self.newuserPage)
        self.newFullnameLe.setObjectName("newFullnameLe")
        self.gridLayout_2.addWidget(self.newFullnameLe, 2, 1, 1, 1)
        ...
        self.newFullnameLabel = QtWidgets.QLabel(self.newuserPage)
        self.newFullnameLabel.setMinimumSize(QtCore.QSize(107, 25))
        self.newFullnameLabel.setObjectName("newFullnameLabel")
        self.gridLayout_2.addWidget(self.newFullnameLabel, 2, 0, 1, 1)
    ...
    def retranslateUi(self, MSColabConnectDialog):
        ...
        self.newFullnameLe.setPlaceholderText(_translate("MSColabConnectDialog", "John Michael Doe"))
        ...
        self.newFullnameLabel.setText(_translate("MSColabConnectDialog", "<html><head/><body><p align=\"right\">Fullname:</p></body></html>"))
        self.newUsernameLabel.setText(_translate("MSColabConnectDialog", "<html><head/><body><p align=\"right\">Username:</p></body></html>"))
