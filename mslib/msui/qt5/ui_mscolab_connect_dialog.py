...
class Ui_MSColabConnectDialog(object):
    def setupUi(self, MSColabConnectDialog):
        ...
        MSColabConnectDialog.resize(478, 341)
        ...
        self.loginByIDPLe = QtWidgets.QLabel(self.loginPage)
        self.loginByIDPLe.setAlignment(QtCore.Qt.AlignCenter)
        self.loginByIDPLe.setObjectName("loginByIDPLe")
        self.gridLayout_3.addWidget(self.loginByIDPLe, 6, 0, 1, 2)
        ...
        self.line_3 = QtWidgets.QFrame(self.loginPage)
        ...
        self.gridLayout_3.addWidget(self.loginWithIDPBtn, 7, 0, 1, 2)
    ...
    def retranslateUi(self, MSColabConnectDialog):
        ...
        self.loginByIDPLe.setText(_translate("MSColabConnectDialog", "Login With"))
        ...
        self.loginWithIDPBtn.setText(_translate("MSColabConnectDialog", "Identity Provider"))
