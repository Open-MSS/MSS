...
class Ui_ProfileWindow(object):
    def setupUi(self, ProfileWindow):
        ...
        self.nicknameLabel = QtWidgets.QLabel(ProfileWindow)
        self.nicknameLabel.setObjectName("nicknameLabel")
        self.infoGl.addWidget(self.nicknameLabel, 3, 0, 1, 1)
        self.label_4 = QtWidgets.QLabel(ProfileWindow)
        self.label_4.setObjectName("label_4")
        self.infoGl.addWidget(self.label_4, 3, 1, 1, 1, QtCore.Qt.AlignLeft)
        self.nicknameValue = QtWidgets.QLabel(ProfileWindow)
        self.nicknameValue.setText("")
        self.nicknameValue.setObjectName("nicknameValue")
        self.infoGl.addWidget(self.nicknameValue, 3, 2, 1, 1)
        self.fullNameLabel = QtWidgets.QLabel(ProfileWindow)
        self.fullNameLabel.setObjectName("fullNameLabel")
        self.infoGl.addWidget(self.fullNameLabel, 4, 0, 1, 1)
        self.label_5 = QtWidgets.QLabel(ProfileWindow)
        self.label_5.setObjectName("label_5")
        self.infoGl.addWidget(self.label_5, 4, 1, 1, 1, QtCore.Qt.AlignLeft)
        ...
        self.infoGl.addWidget(self.fullNameValue, 4, 2, 1, 1)
    ...
    def retranslateUi(self, ProfileWindow):
        ...
        self.nicknameLabel.setText(_translate("ProfileWindow", "Nickname"))
        self.label_4.setText(_translate("ProfileWindow", ":"))
