...
class Ui_ProfileWindow(object):
    def setupUi(self, ProfileWindow):
        ...
        self.infoGl.addWidget(self.fullNameLabel, 1, 0, 1, 1)
        self.fullNameLabel_2 = QtWidgets.QLabel(ProfileWindow)
        self.fullNameLabel_2.setText("")
        self.fullNameLabel_2.setObjectName("fullNameLabel_2")
        self.infoGl.addWidget(self.fullNameLabel_2, 1, 2, 1, 1)
        self.emailLabel = QtWidgets.QLabel(ProfileWindow)
        self.emailLabel.setObjectName("emailLabel")
        self.infoGl.addWidget(self.emailLabel, 2, 0, 1, 1)
        self.mscolabURLLabel = QtWidgets.QLabel(ProfileWindow)
        self.mscolabURLLabel.setObjectName("mscolabURLLabel")
        self.infoGl.addWidget(self.mscolabURLLabel, 3, 0, 1, 1)
    ...
    def retranslateUi(self, ProfileWindow):
        ...
        self.usernameLabel.setText(_translate("ProfileWindow", "Username"))
