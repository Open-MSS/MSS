...
class Ui_MscolabProject(object):
    def setupUi(self, MscolabProject):
        ...
        self.proj_info = QtWidgets.QLabel(MscolabProject)
        self.proj_info.setGeometry(QtCore.QRect(460, 20, 200, 15))
        self.proj_info.setText("")
        self.proj_info.setObjectName("proj_info")
        self.user_info = QtWidgets.QLabel(MscolabProject)
        self.user_info.setGeometry(QtCore.QRect(460, 40, 200, 15))
