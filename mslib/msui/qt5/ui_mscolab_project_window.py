...
class Ui_MscolabProject(object):
    def setupUi(self, MscolabProject):
        ...
        self.messageText.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByKeyboard|QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextBrowserInteraction|QtCore.Qt.TextEditable|QtCore.Qt.TextEditorInteraction|QtCore.Qt.TextSelectableByKeyboard|QtCore.Qt.TextSelectableByMouse)
        ...
        self.verticalLayout.addWidget(self.sendMessage)
        self.deleteMessageBtn = QtWidgets.QPushButton(self.centralwidget)
        self.deleteMessageBtn.setObjectName("deleteMessageBtn")
        self.verticalLayout.addWidget(self.deleteMessageBtn)
    ...
    def retranslateUi(self, MscolabProject):
        ...
        self.deleteMessageBtn.setText(_translate("MscolabProject", "Delete"))
