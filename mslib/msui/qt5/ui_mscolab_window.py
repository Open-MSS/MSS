...
class Ui_MSSMscolabWindow(object):
    def setupUi(self, MSSMscolabWindow):
        ...
        MSSMscolabWindow.resize(474, 451)
        ...
        self.verticalLayoutWidget_5.setGeometry(QtCore.QRect(0, 0, 471, 446))
        ...
        self.url = QtWidgets.QLineEdit(self.urlWidget)
    ...
    def retranslateUi(self, MSSMscolabWindow):
        ...
        self.url.setPlaceholderText(_translate("MSSMscolabWindow", "url"))
