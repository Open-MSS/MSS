...
class Ui_SideViewOptionsDialog(object):
    def setupUi(self, SideViewOptionsDialog):
        ...
        self.cbMarker = QtWidgets.QCheckBox(self.groupBox_3)
        self.cbMarker.setObjectName("cbMarker")
        self.horizontalLayout_8.addWidget(self.cbMarker)
    ...
    def retranslateUi(self, SideViewOptionsDialog):
        ...
        self.cbMarker.setToolTip(_translate("SideViewOptionsDialog", "Draw a circle marker on every waypoint along the flight track"))
        self.cbMarker.setText(_translate("SideViewOptionsDialog", "draw marker"))
