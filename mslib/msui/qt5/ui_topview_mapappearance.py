...
class Ui_MapAppearanceDialog(object):
    def setupUi(self, MapAppearanceDialog):
        ...
        self.cbAirspaces = CheckableComboBox(MapAppearanceDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cbAirspaces.sizePolicy().hasHeightForWidth())
        self.cbAirspaces.setSizePolicy(sizePolicy)
        self.cbAirspaces.setMinimumSize(QtCore.QSize(0, 0))
