...
class Ui_MapAppearanceDialog(object):
    def setupUi(self, MapAppearanceDialog):
        ...
        self.cbAirportType = CheckableComboBox(MapAppearanceDialog)
        ...
        self.cbAirspaces.setMinimumSize(QtCore.QSize(135, 0))
        self.cbAirspaces.setObjectName("cbAirspaces")
        self.horizontalLayout_7.addWidget(self.cbAirspaces)
        self.btDownloadAsp = QtWidgets.QPushButton(MapAppearanceDialog)
    ...
    def retranslateUi(self, MapAppearanceDialog):
        ...
        self.btDownloadAsp.setText(_translate("MapAppearanceDialog", "Update/Download"))
