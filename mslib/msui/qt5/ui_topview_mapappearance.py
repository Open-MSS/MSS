...
class Ui_MapAppearanceDialog(object):
    def setupUi(self, MapAppearanceDialog):
        ...
        MapAppearanceDialog.resize(462, 411)
        ...
        self.cbDrawAirbases = QtWidgets.QCheckBox(MapAppearanceDialog)
        self.cbDrawAirbases.setObjectName("cbDrawAirbases")
        self.horizontalLayout_7.addWidget(self.cbDrawAirbases)
    ...
    def retranslateUi(self, MapAppearanceDialog):
        ...
        self.cbDrawAirbases.setText(_translate("MapAppearanceDialog", "draw airspaces"))
