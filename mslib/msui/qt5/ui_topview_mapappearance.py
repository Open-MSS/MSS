...
class Ui_MapAppearanceDialog(object):
    def setupUi(self, MapAppearanceDialog):
        ...
        MapAppearanceDialog.resize(462, 463)
        ...
        self.cbAirportType = QtWidgets.QComboBox(MapAppearanceDialog)
        self.cbAirportType.setMinimumSize(QtCore.QSize(135, 0))
        self.cbAirportType.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.cbAirportType.setObjectName("cbAirportType")
        self.cbAirportType.addItem("")
        self.cbAirportType.addItem("")
        self.cbAirportType.addItem("")
        self.cbAirportType.addItem("")
        self.cbAirportType.addItem("")
        ...
        self.btDownload = QtWidgets.QPushButton(MapAppearanceDialog)
        ...
        self.line = QtWidgets.QFrame(MapAppearanceDialog)
        ...
        self.cbDrawAirspaces = QtWidgets.QCheckBox(MapAppearanceDialog)
        self.cbDrawAirspaces.setObjectName("cbDrawAirspaces")
        self.horizontalLayout_7.addWidget(self.cbDrawAirspaces)
        self.label_2 = QtWidgets.QLabel(MapAppearanceDialog)
        ...
        self.cbFilterAirspaces = QtWidgets.QCheckBox(MapAppearanceDialog)
        ...
        self.label_3 = QtWidgets.QLabel(MapAppearanceDialog)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_8.addWidget(self.label_3)
        self.sbFrom = QtWidgets.QDoubleSpinBox(MapAppearanceDialog)
        ...
        self.label_4 = QtWidgets.QLabel(MapAppearanceDialog)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_8.addWidget(self.label_4)
        self.sbTo = QtWidgets.QDoubleSpinBox(MapAppearanceDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.line_2 = QtWidgets.QFrame(MapAppearanceDialog)
    ...
    def retranslateUi(self, MapAppearanceDialog):
        ...
        self.cbAirportType.setItemText(0, _translate("MapAppearanceDialog", "small_airport"))
        self.cbAirportType.setItemText(1, _translate("MapAppearanceDialog", "medium_airport"))
        self.cbAirportType.setItemText(2, _translate("MapAppearanceDialog", "large_airport"))
        self.cbAirportType.setItemText(3, _translate("MapAppearanceDialog", "heliport"))
        self.cbAirportType.setItemText(4, _translate("MapAppearanceDialog", "balloonport"))
        self.cbAirportType.setItemText(5, _translate("MapAppearanceDialog", "seaplane_base"))
        self.cbAirportType.setItemText(6, _translate("MapAppearanceDialog", "closed"))
        self.btDownload.setText(_translate("MapAppearanceDialog", "Update/Download"))
        self.cbDrawAirspaces.setText(_translate("MapAppearanceDialog", "draw airspaces"))
        self.label_2.setText(_translate("MapAppearanceDialog", "<html><head/><body><p><a href=\"http://www.openaip.net/user/login\"><span style=\" text-decoration: underline; color:#0000ff;\">Login</span></a> then <a href=\"http://www.openaip.net/downloads/airspaces\"><span style=\" text-decoration: underline; color:#0000ff;\">Download</span></a> the desired .aip airspace files</p><p>Put the downloaded files into <a href=\"MSS_CONFIG_PATH\"><span style=\" text-decoration: underline; color:#0000ff;\">this directory</span></a></p></body></html>"))
        self.cbFilterAirspaces.setText(_translate("MapAppearanceDialog", "filter airspaces"))
        self.label_3.setText(_translate("MapAppearanceDialog", "from"))
        self.sbFrom.setSuffix(_translate("MapAppearanceDialog", " km"))
        self.label_4.setText(_translate("MapAppearanceDialog", "to"))
        self.sbTo.setSuffix(_translate("MapAppearanceDialog", " km"))
