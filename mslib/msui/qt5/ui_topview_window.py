...
class Ui_TopViewWindow(object):
    ...
    def retranslateUi(self, TopViewWindow):
        ...
        self.cbTools.setItemText(0, _translate("TopViewWindow", "Web Map Service"))
        self.cbTools.setItemText(1, _translate("TopViewWindow", "Satellite Tracks"))
        self.cbTools.setItemText(2, _translate("TopViewWindow", "Remote Sensing"))
        self.cbTools.setItemText(3, _translate("TopViewWindow", "KML Overlay"))
        self.cbTools.setItemText(4, _translate("TopViewWindow", "Airports/Airspaces"))
        self.cbTools.setItemText(5, _translate("TopViewWindow", "Multiple Flightpath"))
