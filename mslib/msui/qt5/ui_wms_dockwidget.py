...
class Ui_WMSDockWidget(object):
    def setupUi(self, WMSDockWidget):
        ...
        self.dteValidTime.setDate(QtCore.QDate(2009, 12, 30))
        self.dteValidTime.setMinimumDateTime(QtCore.QDateTime(QtCore.QDate(1999, 12, 31), QtCore.QTime(13, 0, 0)))
        self.dteValidTime.setMinimumDate(QtCore.QDate(1999, 12, 31))
        self.dteValidTime.setMinimumTime(QtCore.QTime(13, 0, 0))
    ...
    def retranslateUi(self, WMSDockWidget):
        ...
        self.pbLayerSelect.setText(_translate("WMSDockWidget", "Select Layer"))
