...
2) Configure your Apache server according to apache_config/wms_wsgi.sample
...
from case_insensitive_multi_dict import CaseInsensitiveMultiDict
...
views = PageTemplateLoader(mss_wms_settings.xml_template_location)
...
app = WMSServer(mss_config.nwpaccess)
